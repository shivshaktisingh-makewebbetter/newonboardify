    ...
    <div className="d-flex align-items-center" style={{ gap: "5px" }}>
      <div>
        <span
          ...
          style={{width: "30px", height: "30px" , background: "#497ed8" , paddingTop:userName !== "Onboardify Team"?"3px":"0px" }}
        >
          {userName === "Onboardify Team" ? <img src="/onboard123.svg" alt="No Preview" width={30} height={30}/>  : getFirstLettersOfName(userName)}
        </span>
      </div>
